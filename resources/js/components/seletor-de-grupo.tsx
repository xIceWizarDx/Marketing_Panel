...
import GerenciarGrupos from '@/components/grupo/gerenciar-grupos';
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="start" className="w-60">
                    ...
                    <DropdownMenuItem onSelect={() => setGerenciando(true)} className="gap-2">
            ...
            <GerenciarGrupos aberta={gerenciando} aoFechar={() => setGerenciando(false)} />
        </>
    );
}
